...
class Critic(nn.Module):
	def __init__(self, state_dim, action_dim):
		...
		# Q1 architecture
		self.l11 = nn.Linear(state_dim, 128)
		self.l12 = nn.Linear(action_dim, 128)
		self.l2 = nn.Linear(256, 256)
		self.l3 = nn.Linear(256, 1)

		# Q2 architecture
		self.l41 = nn.Linear(state_dim, 128)
		self.l42 = nn.Linear(action_dim, 128)
	...
	def forward(self, state, action):
		...
		q11 = F.relu(self.l11(state))
		q12 = F.relu(self.l12(action))

		q1 = torch.cat([q11, q12], 1)
		q1 = F.relu(self.l2(q1))
		q1 = self.l3(q1)


		q21 = F.relu(self.l41(state))
		q22 = F.relu(self.l42(action))

		q2 = torch.cat([q21, q22], 1)
