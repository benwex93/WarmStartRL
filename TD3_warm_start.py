...
class TD3_warm_start(object):
	def __init__(
		...
		self.backup_actor = Actor(state_dim, action_dim, max_action).to(device)
		...
		self.loaded_backup_actor = False
	...
	def load_policy(self, filename):
		...
		self.backup_actor.load_state_dict(torch.load(filename + "_actor"))